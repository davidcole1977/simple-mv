...
prototype = {
  bind: function bind (options) {
    ...
    // appSubsList.createSubscription(EVENT_TYPES.DATUM_UPDATE + eventNameSpace, this.receiveBindEvent.bind(this, modelDatum, viewDatum));
  }, 
  ...
  addListener: function addListener (options, callback) {
    ...
    appSubsList.createSubscription(options.event + ':' + options.model.id + eventNameSpace, callback);
  },
